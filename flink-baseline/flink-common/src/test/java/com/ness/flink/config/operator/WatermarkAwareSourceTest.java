...
class WatermarkAwareSourceTest {
    ...
    void shouldCreateCustomWatermarkStrategy() {
        ...
        var watermarkGenerator = watermarkStrategy.createWatermarkGenerator(org.mockito.Mockito.mock(org.apache.flink.api.common.eventtime.WatermarkGeneratorSupplier.Context.class));
