...
class FlinkEnvironmentPropertiesTest {
    ...
    void shouldGetDefaultValues() {
        ...
        Assertions.assertFalse(properties.isRestFlameGraph());
        ...
        Assertions.assertTrue(properties.isDisableAutoGeneratedUid());
    }
    ...
    void shouldOverwriteDisableAutoGeneratedUIDsFromEnv() {
        var properties = FlinkEnvironmentProperties.from(ParameterTool.fromMap(Map.of()));
        Assertions.assertFalse(properties.isDisableAutoGeneratedUid());
    }

    @Test
    @SetEnvironmentVariable(key = "ENVIRONMENT_REST_FLAME_GRAPH", value = "true")
    void shouldEnableRestFlameGraphFromEnv() {
        var properties = FlinkEnvironmentProperties.from(ParameterTool.fromMap(Map.of()));
        Assertions.assertTrue(properties.isRestFlameGraph());
    }
}